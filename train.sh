...
python main.py  \
--config config/nturgbd-cross-subject/joint.yaml --model model.Hyperformer_tiny.Model --work-dir work_dir/ntu60/csub/Hyperformer_joint  --device 1 --base-lr 0.000015 --weights /home/runs-94-20658.pt --start-epoch 94
