...
python main.py  \
--config config/nturgbd-cross-subject/joint.yaml --model model.Hyperformer_tiny.Model --work-dir work_dir/ntu60/csub/Hyperformer_joint  --device 1 --base-lr 2.5e-2
